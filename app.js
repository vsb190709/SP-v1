...
async function cloudSaveSettings(){
  ...
  const s={...state.settings}; delete s.logo; s.mandalName=FIXED_NAME;
...
async function cloudLoad(){
  ...
  state.settings.mandalName=FIXED_NAME;
  state.settings.logo=FIXED_LOGO;
